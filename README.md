...
To install all the required software you need to do the following. Note this was tested on a clean install of Ubuntu 18.04.
...
https://packages.ubuntu.com/xenial/amd64/libgazebo7-dev/download
